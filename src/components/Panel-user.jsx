  ...
  render() {
    ...
    return (
      <div {...this.props.profile.id} className="panel-lateral">
        <img src="https://cdn.hobbyconsolas.com/sites/navi.axelspringer.es/public/styles/main_element/public/media/image/2019/09/spider-man-lejos-casa.jpg?itok=BpCgLmBD" alt="avatar" /> 
